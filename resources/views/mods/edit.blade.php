...
<header class="fixed bg-pink-500 top-0 left-0 right-0 z-0 grid grid-rows-1 grid-cols-3 ">
...
<main class="grid grid-rows-3 col-span-3 py-1">
    ...
    @section('content')
        <div class="container mx-auto">
            <h2 class="text-2xl font-bold">Edit Mods</h2>
            <form method="POST" action="{{ route('mods.index', ['index' => $mod]) }}">
                @csrf
                @method('PUT')

                <div class="mb-4 text-black">
                    <label for="title" class="block text-sm font-medium text-white">Title</label>
                    <input type="text" id="title" name="title" class="form-input" value="{{ $mod }}">
                </div>
                <div class="mb-4 text-black">
                    <label for="creator" class="block text-sm font-medium text-white">Creator</label>
                    <input type="text" id="creator" name="creator" class="form-input">
                </div>
                <div class="mb-4 text-black">
                    <label for="version" class="block text-sm font-medium text-white">Version</label>
...
<footer class="fixed bottom-0 left-0 right-0 bg-pink-500 p-4 text-center grid grid-rows-5 col-span-3 h-12">
    <div class="container mx-auto">
